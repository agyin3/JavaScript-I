...
const parent = {
  ...
  child: {
    ...
    age: 50,
    speak: function() {
      return console.log(`Hey everyone, I'm ${this.name} and ${parent.name} is my Mom!`);
    },
    grandchild: {
      name: "Sam",
      age: 30,
      speak: function() {
        return console.log(`What's up everybody! My name is ${this.name}. My grandma ${parent.name} always spoils me and my dad, ${parent.child.name} doesn't like that.`);
      }
    }
  }
}
